...
fruits_with_more_than_two_vowels = [fruit for fruit in fruits if in_vowel(fruit) > 2]
print(fruits_with_more_than_two_vowels)

# Exercise 4 - make a variable named fruits_with_only_two_vowels. The result should be ['mango', 'kiwi', 'strawberry']

fruits_with_only_two_vowels = [fruit for fruit in fruits if in_vowel(fruit) == 2]
...
numbers_with_2_or_more_numerals = [number for number in numbers if number // 10 > 0]
...
primes = [number for number in numbers if is_primes(number) and number > 0]
print(primes)
